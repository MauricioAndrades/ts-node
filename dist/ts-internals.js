...
function combinePaths(path, ...paths) {
    return normalizeSlashes(resolve(path, ...paths.filter((path) => path)));
}
 ...
 */
export function getPatternFromSpec(spec, basePath) {
...
export function getUseDefineForClassFields(compilerOptions) {
