...
/** @internal */
export function REPL_FILENAME(tsVersion) {
...
export function createRepl(options = {}) {
    ...
    function startInternal(options) {
        ...
        const repl = getNodeRepl().start({
            ...
            terminal: stdout.isTTY && !parseInt(env.NODE_NO_READLINE, 10),
            eval: nodeEval,
            useGlobal: true,
            ...optionsOverride,
        });
...
export function createEvalAwarePartialHost(state, composeWith) {
 ...
 */
export function setupContext(context, module, filenameAndDirname) {
