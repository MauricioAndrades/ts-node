...
import { cachedLookup, createProjectLocalResolveHelper, hasOwnProperty, normalizeSlashes, once, parse, split, versionGteLt, yn, } from './util';
...
export function register(serviceOrOpts) {
 ...
 * @category ESM Loader
 */
export const createEsmHooks = (tsNodeService) => require('./esm').createEsmHooks(tsNodeService);
